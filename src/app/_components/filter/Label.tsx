...
const labelClassMap = {
  name: "bg-red-500/20 text-red-300 ring-red-500/30",
  category: "bg-amber-500/20 text-amber-300 ring-amber-500/30",
  stock: "bg-lime-500/20 text-lime-300 ring-lime-500/30",
  price: "bg-emerald-500/20 text-emerald-300 ring-emerald-500/30",
  rating: "bg-sky-500/20 text-sky-300 ring-sky-500/30",
...
const labelColors = {
  name: labelClassMap["name"],
  category: labelClassMap["category"],
  stock: labelClassMap["stock"],
  price: labelClassMap["price"],
...
export function ClickableLabel({
  ...
  return (
    <button
      onClick={onRemove}
      className={`cursor-pointer rounded px-[9px] py-0.5 ring-1 transition ring-inset hover:opacity-80 ${labelColors[colorType]} ${className}`}
    >
      {label}
    </button>
  );

...
import { UploadButton, UploadDropzone } from "~/server/utils/uploadthing";
...
export default function AddProductForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5 text-sm">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            required
            className="rounded bg-gray-900 p-2 outline-none"
          />
        </div>
        <div className="flex flex-col gap-1">
          <label
          ...
          <select
            ...
            required
            className="scrollbar-thin rounded bg-gray-900 p-2 outline-none"
          >
            {categories?.map((cat) => (
        ...
        <div className="flex flex-col gap-1">
          ...
          <div id="options" className="flex flex-col gap-1">
            {/* 1st key & its values */}
            <div className="flex gap-1">
              {/* add option key button (eg color, etc.) */}
              <div className="flex flex-col gap-1">
              ...
              {/* add option value button (eg red, green, etc.) */}
            </div>
            {/* more keys & values */}
            {/* button to generate variants from the above options */}
          </div>
        </div>
        <div className="flex flex-col gap-1">
          <label
          ...
          <div id="variants" className="flex flex-col gap-3">
            {/* 1st variant */}
            <div className="flex flex-col gap-3">
      ...
      {/* Error and Submit */}
      {error && (
        <div className="rounded-md bg-red-900/50 p-3 text-red-400">{error}</div>
      )}
